...
<section class="container py-5 mt-5">
    ...
    <div class="row">
        <div class="col-12 col-md-4 p-5 mt-3">
            <a href="Uniformes_FT.php"><img src="../imagenes/Uniformes.jpg" class="rounded-circle img-fluid border"></a>
        ...
        <div class="col-12 col-md-4 p-5 mt-3">
            <a href="parches.php"><img src="../imagenes/condecoraciones.jpeg"
                    class="rounded-circle img-fluid border"></a>
            <h2 class="h5 text-center mt-3 mb-3">Distintivos y Condecoraciones</h2>
            <p class="text-center"><a href="parches.php" class="btn btn-success">Ver Mas</a></p>
        </div>
    </div>
</section>
